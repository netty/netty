...
public final class HttpResponseBuilder {
    ...
    public static final String NO_CACHE_HEADER =  "no-store, no-cache, no-transform, must-revalidate, max-age=0";
     ...
     * @return {@link HttpResponseBuilder} to support method chaining.
     */
    public HttpResponseBuilder header(final AsciiString name, final AsciiString value) {
    ...
    private void addAllHeaders(final HttpResponse response) {
        ...
        if (chunked && response.protocolVersion() == HttpVersion.HTTP_1_1) {
