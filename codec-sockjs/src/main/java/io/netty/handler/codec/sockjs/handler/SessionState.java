...
interface SessionState {
    ...
    /**
     * Returns the {@link ChannelHandlerContext} that should be used to communicate with the client.
    ...
    /**
     * Returns the session identifier for this session state instance.
     *
     * @return {@code String} the session id.
     */
    String sessionId();
