...
public class SockJsHandler extends ChannelInboundHandlerAdapter {
    ...
    private static void handleSession(final SockJsServiceFactory factory,
        ...
        default:
            ...
            throw new UnsupportedOperationException("Unknown transport type :" + transportType.name());
        }
        ctx.fireChannelRead(request);
    }
    ...
    private static void writeResponse(final Channel channel,
        ...
        try {
            boolean hasKeepAliveHeader = contentEqualsIgnoreCase(KEEP_ALIVE, request.headers().get(CONNECTION));
    ...
    private static final class SessionNotFoundException extends Exception {
        ...
        SessionNotFoundException(final String sessionId, final HttpRequest request) {
