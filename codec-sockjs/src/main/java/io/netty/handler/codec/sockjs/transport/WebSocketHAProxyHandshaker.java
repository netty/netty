...
public class WebSocketHAProxyHandshaker extends WebSocketServerHandshaker00 {
    ...
    protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
        ...
        if (!AsciiString.containsIgnoreCase(UPGRADE, req.headers().get(CONNECTION))
                || !AsciiString.containsIgnoreCase(WEBSOCKET, req.headers().get(UPGRADE))) {
    ...
    public ChannelFuture handshake(Channel channel, FullHttpRequest req) {
        ...
        return channel.writeAndFlush(response).addListener(new HandshakeFutureListener());
    }
