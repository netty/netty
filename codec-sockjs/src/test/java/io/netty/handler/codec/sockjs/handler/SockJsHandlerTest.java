...
public class SockJsHandlerTest {
    ...
    public void nonMatch() {
        final SockJsHandler.PathParams sessionPath = SockJsHandler.sessionPath("/xhr_send");
        assertThat(sessionPath.matches(), is(false));
    }

    @Test
    public void matches() {
        final SockJsHandler.PathParams sessionPath = SockJsHandler.sessionPath("/000/123/xhr_send");
