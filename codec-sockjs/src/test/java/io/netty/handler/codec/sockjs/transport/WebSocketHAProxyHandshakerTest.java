...
public class WebSocketHAProxyHandshakerTest {
    ...
    public void haProxyUpgradeRequest() throws Exception {
        ...
        assertThat(response.headers().getAndConvert(SEC_WEBSOCKET_LOCATION), equalTo("ws://localhost/websocket"));
        assertThat(response.headers().getAndConvert(SEC_WEBSOCKET_ORIGIN), equalTo("http://example.com"));
