...
public class SockJsProtocolTest {
    ...
    /*
     * Equivalent to BaseUrlGreeting.test_notFound in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to IframePage.test_simpleUrl in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to IframePage.test_versionedUrl in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to IframePage.test_queriedUrl in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to IframePage.test_invalidUrl in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to IframePage.test_cacheability in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to InfoTest.test_basic in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to InfoTest.test_entropy in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to InfoTest.test_options in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to InfoTest.test_options_null_origin in sockjs-protocol.py.
     */
    @Test
    public void infoTestOptionsNullOrigin() throws Exception {
        ...
        assertOkResponse(response);
        assertCorsPreflightHeaders(response);
        assertOrigin(response, "null");
        assertAccessControlAllowCredentials(response, true);
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to InfoTest.test_disabled_websocket in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to SessionURLs.test_anyValue in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to SessionURLs.test_invalidPaths in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to SessionURLs.test_ignoringServerId in sockjs-protocol.py.
     */
    @Test
    public void sessionUrlsTestIgnoringServerId() throws Exception {
        ...
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
    ...
    /*
     * Equivalent to Protocol.test_simpleSession in sockjs-protocol.py.
     */
    @Test
    public void protocolTestSimpleSession() throws Exception {
        ...
        assertOpenFrameResponse(sendXhrRequest(serviceFactory));
        verify(echoService).onOpen(any(SockJsSessionContext.class));
        assertNoContent(sendXhrSendRequest(serviceFactory, "[\"a\"]"));
        verify(echoService).onMessage("a");
        assertMessageFrameContent(sendXhrRequest(serviceFactory), "a");
        assertNotFound(xhrSendRequest(serviceFactory, "/echo/111/badsession", "[\"a\"]"));
    }

    /*
     * Equivalent to Protocol.test_closeSession in sockjs-protocol.py.
     */
    @Test
    public void protocolTestCloseSession() throws Exception {
        final SockJsService closeService = spy(new CloseService(SockJsConfig.withPrefix("/close").build()));
        final SockJsServiceFactory serviceFactory = closeServiceFactory(closeService);

        assertOpenFrameResponse(sendXhrRequest(serviceFactory));
        verify(closeService).onOpen(any(SockJsSessionContext.class));
        assertGoAwayResponse(sendXhrRequest(serviceFactory));
        verify(closeService).onClose();
    }

    /*
     * Equivalent to WebSocketHttpErrors.test_httpMethod in sockjs-protocol.py.
     */
    @Test
    public void webSocketHttpErrorsTestHttpMethod() throws Exception {
        ...
        verify(echoService, never()).onOpen(any(SockJsSessionContext.class));
        verify(echoService, never()).onClose();
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to WebSocketHttpErrors.test_invalidConnectionHeader in sockjs-protocol.py.
     */
    @Test
    public void webSocketHttpErrorsTestInvalidConnectionHeader() throws Exception {
        ...
        ch.writeInbound(wsUpgradeRequest(sessionUrlFor(serviceFactory, WEBSOCKET), V13)
                .header(UPGRADE, HttpHeaderValues.WEBSOCKET)
    ...
    /*
     * Equivalent to WebsocketHttpErrors.test_invalidMethod in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHixie76.test_transport in sockjs-protocol.py.
     */
    @Test
    public void webSocketHixie76TestTransport() throws Exception {
        ...
        ch.writeInbound(closeWebSocketFrame(1000, "Client closing"));
        verify(echoService, times(1)).onClose();
        assertWebSocketCloseFrame(ch);
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to WebsocketHixie76.test_close in sockjs-protocol.py.
     */
    @Test
    public void webSocketHixie76TestClose() throws Exception {
        final SockJsConfig config = SockJsConfig.withPrefix("/close").build();
        final SockJsService closeService = spy(new CloseService(config));
        final SockJsServiceFactory serviceFactory = closeServiceFactory(closeService);
        final EmbeddedChannel ch = websocketChannelForService(serviceFactory);
    ...
    /*
     * Equivalent to WebsocketHixie76.test_empty_frame in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHixie76.test_reuseSessionId in sockjs-protocol.py.
     */
    @Test
    public void webSocketHixie76TestReuseSessionId() throws Exception {
        final SockJsConfig config = SockJsConfig.withPrefix("/echo").cookiesNeeded().build();
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsService echoService2 = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
        final SockJsServiceFactory serviceFactory2 = echoServiceFactory(echoService2);
        final EmbeddedChannel ch1 = websocketChannelForService(serviceFactory);
        final EmbeddedChannel ch2 = websocketChannelForService(serviceFactory2);
    ...
    /*
     * Equivalent to WebsocketHixie76.test_haproxy in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHixie76.test_broken_json in sockjs-protocol.py.
     */
    @Test
    public void webSocketHixie76TestBrokenJSON() throws Exception {
        ...
        final SockJsService echoService = spy(new EchoService(config));
        final EmbeddedChannel ch = websocketChannelForService(echoServiceFactory(echoService));
    ...
    /*
     * Equivalent to WebsocketHybi10.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_close in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_headersSantity in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_broken_json in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_transport, but for Hybi17, in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_close, but for Hybi17, in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_broken_json, but for Hybi17, in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to WebsocketHybi10.test_firefox_602_connection_header in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrPolling.test_options in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrPolling.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrPolling.test_invalid_session in sockjs-protocol.py.
     */
    @Test
    public void xhrPollingTestInvalidSession() throws Exception {
        final SockJsConfig config = SockJsConfig.withPrefix("/echo").build();
        final SockJsService echoService = spy(new EchoService(config));
        final FullHttpResponse xhrSendResponse = sendXhrSendRequest(echoServiceFactory(echoService), "[\"x\"]");
        assertThat(xhrSendResponse.status(), is(HttpResponseStatus.NOT_FOUND));
        release(xhrSendResponse);
    }

    /*
     * Equivalent to XhrPolling.test_invalid_json sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrPolling.test_content_types sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrPolling.test_request_headers_cors sockjs-protocol.py.
     */
    @Test
    public void xhrPollingTestRequestHeadersCors() throws Exception {
        ...
        assertOkResponse(response);
        assertOriginLocalhost(response);
        // TODO: look into what has changed here and if the change was correct double
        // check sockjs-protocol test suite which also has this failing test.
    ...
    /*
     * Equivalent to XhrStreaming.test_options in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to XhrStreaming.test_response_limit in sockjs-protocol.py.
     */
    @Test
    public void xhrStreamingTestResponseLimit() throws Exception {
        ...
        verify(echoService, atLeastOnce()).onMessage(any(String.class));
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to EventSource.test_response_limit in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to EventSource.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to HtmlFile.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to HtmlFile.test_no_callback in sockjs-protocol.py.
     */
    @Test
    public void htmlFileTestNoCallback() throws Exception {
        ...
        assertInternalServerError(readFullHttpResponse(ch), Callbacks.CALLBACK_REQUIRED);
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to HtmlFile.test_invalid_callback in sockjs-protocol.py.
     */
    @Test
    public void htmlFileTestInvalidCallback() throws Exception {
        final String serviceName = "/echo";
        final SockJsConfig config = SockJsConfig.withPrefix(serviceName).maxStreamingBytesSize(4096).build();
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
        ...
        ch.writeInbound(getRequest(sessionUrlFor(serviceFactory,  HTMLFILE) + "?c=%20").defaultCors().build());
        assertInvalidCallbackParameter(ch);

        ch.writeInbound(getRequest(sessionUrlFor(serviceFactory,  HTMLFILE) + "?c=*").defaultCors().build());
        assertInvalidCallbackParameter(ch);

        ch.writeInbound(getRequest(sessionUrlFor(serviceFactory,  HTMLFILE) + "?c=abc(").defaultCors().build());
        assertInvalidCallbackParameter(ch);

        ch.writeInbound(getRequest(sessionUrlFor(serviceFactory,  HTMLFILE) + "?c=abc%28(").defaultCors().build());
        assertInvalidCallbackParameter(ch);

        assertChannelFinished(ch);
    }

    private static void assertInvalidCallbackParameter(final EmbeddedChannel ch) {
        assertInternalServerError(readFullHttpResponse(ch), Callbacks.CALLBACK_INVALID);
    }

    /*
     * Equivalent to HtmlFile.test_response_limit in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsonPolling.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsonPolling.test_no_callback in sockjs-protocol.py.
     */
    @Test
    public void jsonpPollingTestNoCallback() throws Exception {
        ...
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
        assertInternalServerError(sendJsonpRequest(serviceFactory, ""), Callbacks.CALLBACK_REQUIRED);
        verify(echoService, never()).onOpen(any(SockJsSessionContext.class));
        verify(echoService, never()).onClose();
    }

    /*
     * Equivalent to JsonPolling.test_invalid_callback in sockjs-protocol.py.
     */
    @Test
    public void jsonpPollingTestInvalidCallback() throws Exception {
        final SockJsConfig config = SockJsConfig.withPrefix("/echo").maxStreamingBytesSize(4096).build();
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
        assertInternalServerError(sendJsonpRequest(serviceFactory, "?c=%20"), Callbacks.CALLBACK_INVALID);
        assertInternalServerError(sendJsonpRequest(serviceFactory, "?c=%20"), Callbacks.CALLBACK_INVALID);
        assertInternalServerError(sendJsonpRequest(serviceFactory, "?c=*"), Callbacks.CALLBACK_INVALID);
        assertInternalServerError(sendJsonpRequest(serviceFactory, "?c=abc("), Callbacks.CALLBACK_INVALID);
        assertInternalServerError(sendJsonpRequest(serviceFactory, "?c=abc%28("), Callbacks.CALLBACK_INVALID);
        verify(echoService, never()).onOpen(any(SockJsSessionContext.class));
        verify(echoService, never()).onClose();
    }

    /*
     * Equivalent to JsonPolling.test_invalid_json in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsonPolling.test_content_types in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsonPolling.test_close in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsessionIdCookie.test_basic in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsessionIdCookie.test_xhr in sockjs-protocol.py.
     */
    @Test
    public void jsessionIdCookieTestXhr() throws Exception {
        sendValidCookieNeededEchoRequest(XHR.path());
        ...
        ch.writeInbound(getRequest(sessionUrlFor(serviceFactory, XHR))
                .defaultCors()
                .cookie(ClientCookieEncoder.LAX.encode("JSESSIONID", "abcdef"))
                .build());
    ...
    /*
     * Equivalent to JsessionIdCookie.test_xhr_streaming in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsessionIdCookie.test_eventsource in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsessionIdCookie.test_htmlfile in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JsessionIdCookie.test_jsonp in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to RawWebsocket.test_transport in sockjs-protocol.py.
     */
    @Test
    ...
    public void webSocketCloseSession() throws Exception {
        ...
        final SockJsConfig config = SockJsConfig.withPrefix(serviceName).build();
        final SockJsService sockJsService = spy(new EchoService(config));
    ...
    /*
     * Equivalent to JSONEncoding.test_xhr_server_encodes in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to JSONEncoding.test_xhr_server_decodes in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to HandlingClose.test_close_frame in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to HandlingClose.test_close_request in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to RawWebsocket.test_close in sockjs-protocol.py.
     */
    @Test
    public void rawWebsocketTestClose() throws Exception {
        ...
        ch.writeInbound(rawWebSocketUpgradeRequest(serviceFactory));
        assertWebSocketUpgradeResponse(ch);
        assertRawWebSocketGoAwayFrame(ch);
        assertChannelFinished(ch);
    }

    /*
     * Equivalent to HandlingClose.test_abort_xhr_streaming in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to HandlingClose.test_abort_xhr_polling in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to Http10.test_synchronous in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to Http10.test_streaming in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to Http11.test_synchronous in sockjs-protocol.py.
     */
    @Test
    ...
    /*
     * Equivalent to Http11.test_streaming in sockjs-protocol.py.
     */
    @Test
    ...
    private static void sendValidCookieNeededEchoRequest(final String transportPath) throws Exception {
        final String serviceName = "/cookie_needed_echo";
        final String sessionUrl = serviceName + "/abc/" + UUID.randomUUID();
        final SockJsConfig config = SockJsConfig.withPrefix(serviceName).cookiesNeeded().build();
        final SockJsService echoService = spy(new EchoService(config));
        final EmbeddedChannel ch = channelForService(echoServiceFactory(echoService));
    ...
    private void sendValidWebSocketRequest(final WebSocketVersion version) throws Exception {
        ...
        final EmbeddedChannel ch = webSocketChannel(echoServiceFactory(echoService), corsConfig());
    ...
    private void assertWebSocketTestClose(final WebSocketVersion version) {
        ...
        assertWebSocketGoAwayFrame(ch);
        assertWebSocketCloseFrame(ch);
        verify(closeService, times(1)).onClose();
        assertChannelFinished(ch);
    }

    private void assertWebSocketTestBrokenJSON(final WebSocketVersion version) throws Exception {
        final String serviceName = "/close";
        final SockJsConfig config = SockJsConfig.withPrefix(serviceName).build();
        final SockJsService echoService = spy(new EchoService(config));
        final SockJsServiceFactory serviceFactory = echoServiceFactory(echoService);
        ...
        ch.writeInbound(textWebSocketFrame("[\"a\""));
        assertWebSocketCloseFrame(ch);
        verify(echoService, never()).onMessage(any(String.class));
        verify(echoService).onClose();
        assertThat(ch.isActive(), is(false));
        assertChannelFinished(ch);
    }
    ...
    private FullHttpRequest rawWebSocketUpgradeRequest(final SockJsServiceFactory factory) {
        final String url = factory.config().prefix() + WEBSOCKET.path();
        return wsUpgradeRequest(url, V13).build();
    }
    ...
    private static void sendSuccessfulRequest(final String sessionPart) {
        final SockJsConfig config = SockJsConfig.withPrefix("/echo").cookiesNeeded().build();
        final EmbeddedChannel ch = channelForMockService(config);
        ch.writeInbound(getRequest("/echo" + sessionPart + XHR.path()).defaultCors().build());
        final FullHttpResponse response = ch.readOutbound();
        assertOpenFrameResponse(response);
    }
    ...
    private static CloseWebSocketFrame closeWebSocketFrame(final int code, final String content) {
        return new CloseWebSocketFrame(code, content);
    }
