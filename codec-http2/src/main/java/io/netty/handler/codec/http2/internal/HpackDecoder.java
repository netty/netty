...
import io.netty.handler.codec.http2.internal.HpackUtil.IndexType;
...
public final class HpackDecoder {
    private static final Http2Exception DECODE_ULE_128_DECOMPRESSION_EXCEPTION =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - decompression failure",
    ...
    private static final Http2Exception DECODE_ULE_128_TO_LONG_DECOMPRESSION_EXCEPTION =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - long overflow",
    ...
    private static final Http2Exception DECODE_ULE_128_TO_INT_DECOMPRESSION_EXCEPTION =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - int overflow",
    ...
    private static final Http2Exception DECODE_ILLEGAL_INDEX_VALUE =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - illegal index value",
    ...
    private static final Http2Exception INVALID_MAX_DYNAMIC_TABLE_SIZE =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - invalid max dynamic table size",
                    Http2Exception.ShutdownHint.HARD_SHUTDOWN, HpackDecoder.class,
            "setDynamicTableSize(..)");
    private static final Http2Exception MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED =
            StacklessHttp2Exception.newStatic(COMPRESSION_ERROR, "HPACK - max dynamic table size change required",
                    Http2Exception.ShutdownHint.HARD_SHUTDOWN, HpackDecoder.class, "decode(..)");
     ...
     */
    public HpackDecoder(long maxHeaderListSize, int maxHeaderTableSize) {
     ...
     */
    public HpackHeaderField getHeaderField(int index) {
