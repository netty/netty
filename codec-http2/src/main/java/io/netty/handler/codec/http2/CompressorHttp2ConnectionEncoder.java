...
public class CompressorHttp2ConnectionEncoder extends DecoratingHttp2ConnectionEncoder {
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext ctx, int streamId, Http2Headers headers, int padding,
        ...
        try {
            ...
            EmbeddedChannel compressor = initCompressor(headers, endStream);
            ...
            afterWriteHeaders(compressor, streamId);
    ...
    public ChannelFuture writeHeaders(final ChannelHandlerContext ctx, final int streamId, final Http2Headers headers,
        ...
        try {
            // Determine if compression is required and sanitize the headers.
            EmbeddedChannel compressor = initCompressor(headers, endOfStream);
     ...
     */
    private EmbeddedChannel initCompressor(Http2Headers headers, boolean endOfStream) throws Http2Exception {
        if (endOfStream) {
            return null;
        }
     ...
     */
    private void afterWriteHeaders(EmbeddedChannel compressor, int streamId) {
        if (compressor != null) {
