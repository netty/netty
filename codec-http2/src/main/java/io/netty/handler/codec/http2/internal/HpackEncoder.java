...
import static io.netty.handler.codec.http2.internal.HpackUtil.equalsConstantTime;
import static io.netty.handler.codec.http2.internal.HpackUtil.equalsVariableTime;
...
public final class HpackEncoder {
    ...
    public static final int HUFF_CODE_THRESHOLD = 512;
