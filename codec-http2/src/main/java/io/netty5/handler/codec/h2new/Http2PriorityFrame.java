...
/**
 * An <a href="https://httpwg.org/specs/rfc7540.html#PRIORITY">HTTP/2 priority frame</a>.
 */
public interface Http2PriorityFrame extends Http2RequestStreamFrame {
    ...
    /**
     * Returns a positive number indicating the stream dependency.
     *
     * @return A positive number indicating the stream dependency.
     */
