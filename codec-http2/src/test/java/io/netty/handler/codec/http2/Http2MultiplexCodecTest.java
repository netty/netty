...
public class Http2MultiplexCodecTest {
    ...
    private final Http2FrameWriter frameWriter = spy(new DefaultHttp2FrameWriter());
    private final Http2MultiplexCodec serverCodec
        = new Http2MultiplexCodec(true, streamInit, null, frameWriter);
    ...
    private ChannelHandlerContext serverCodecCtx;
    ...
    public void setUp() throws Exception {
        ...
        serverCodecCtx = channel.pipeline().context(serverCodec);
    ...
    public void entityRequestEntityResponse() throws Exception {
        ...
        assertEquals(new DefaultHttp2DataFrame(bb("hello"), true, 31), inboundData);
        ...
        assertEquals(bb("world"), outboundData.getValue());
    ...
    static class LastInboundHandler extends ChannelHandlerAdapter {
