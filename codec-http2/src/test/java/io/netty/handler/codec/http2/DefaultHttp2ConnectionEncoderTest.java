...
public class DefaultHttp2ConnectionEncoderTest {
    ...
    public void setup() throws Exception {
        ...
        doAnswer(new Answer<ChannelFuture>() {
            ...
            public ChannelFuture answer(InvocationOnMock in) throws Throwable {
                ChannelPromise promise = (ChannelPromise) in.getArguments()[2];
                promise.trySuccess();
                return promise;
            }
        ...
        doAnswer(new Answer<ChannelFuture>() {
            ...
            public ChannelFuture answer(InvocationOnMock in) throws Throwable {
                ...
                ChannelPromise promise = (ChannelPromise) in.getArguments()[4];
                promise.trySuccess();
                return promise;
            }
    ...
    public void paddingSplitOverFrame() throws Exception {
        ...
        final ByteBuf data = dummyData();
        encoder.writeData(ctx, STREAM_ID, data, 5, true, newPromise());
    ...
    public void frameShouldSplitPadding() throws Exception {
        ...
        encoder.writeData(ctx, STREAM_ID, data, 10, true, newPromise());
    ...
    private void goAwayReceived(int lastStreamId) {
        connection.goAwayReceived(lastStreamId, 0, Unpooled.EMPTY_BUFFER);
    }
