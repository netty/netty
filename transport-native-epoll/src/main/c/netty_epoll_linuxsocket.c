...
static void netty_epoll_linuxsocket_getTcpInfo(JNIEnv* env, jclass clazz, jint fd, jintArray array) {
     ...
     jint cArray[32];
     cArray[0] = (jint) tcp_info.tcpi_state;
     cArray[1] = (jint) tcp_info.tcpi_ca_state;
     cArray[2] = (jint) tcp_info.tcpi_retransmits;
     cArray[3] = (jint) tcp_info.tcpi_probes;
     cArray[4] = (jint) tcp_info.tcpi_backoff;
     cArray[5] = (jint) tcp_info.tcpi_options;
     cArray[6] = (jint) tcp_info.tcpi_snd_wscale;
     cArray[7] = (jint) tcp_info.tcpi_rcv_wscale;
     cArray[8] = (jint) tcp_info.tcpi_rto;
     cArray[9] = (jint) tcp_info.tcpi_ato;
     cArray[10] = (jint) tcp_info.tcpi_snd_mss;
     cArray[11] = (jint) tcp_info.tcpi_rcv_mss;
     cArray[12] = (jint) tcp_info.tcpi_unacked;
     cArray[13] = (jint) tcp_info.tcpi_sacked;
     cArray[14] = (jint) tcp_info.tcpi_lost;
     cArray[15] = (jint) tcp_info.tcpi_retrans;
     cArray[16] = (jint) tcp_info.tcpi_fackets;
     cArray[17] = (jint) tcp_info.tcpi_last_data_sent;
     cArray[18] = (jint) tcp_info.tcpi_last_ack_sent;
     cArray[19] = (jint) tcp_info.tcpi_last_data_recv;
     cArray[20] = (jint) tcp_info.tcpi_last_ack_recv;
     cArray[21] = (jint) tcp_info.tcpi_pmtu;
     cArray[22] = (jint) tcp_info.tcpi_rcv_ssthresh;
     cArray[23] = (jint) tcp_info.tcpi_rtt;
     cArray[24] = (jint) tcp_info.tcpi_rttvar;
     cArray[25] = (jint) tcp_info.tcpi_snd_ssthresh;
     cArray[26] = (jint) tcp_info.tcpi_snd_cwnd;
     cArray[27] = (jint) tcp_info.tcpi_advmss;
     cArray[28] = (jint) tcp_info.tcpi_reordering;
     cArray[29] = (jint) tcp_info.tcpi_rcv_rtt;
     cArray[30] = (jint) tcp_info.tcpi_rcv_space;
     cArray[31] = (jint) tcp_info.tcpi_total_retrans;
