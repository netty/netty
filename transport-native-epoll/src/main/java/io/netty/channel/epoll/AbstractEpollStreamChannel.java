...
public abstract class AbstractEpollStreamChannel extends AbstractEpollChannel implements DuplexChannel {
    ...
    protected AbstractEpollStreamChannel(Channel parent, Socket fd) {
        this(parent, fd, true, null);
    }

    protected AbstractEpollStreamChannel(Channel parent, Socket fd, boolean active, InetSocketAddress remote) {
        super(parent, fd, Native.EPOLLIN, active, remote);
