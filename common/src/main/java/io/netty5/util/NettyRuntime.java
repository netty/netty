...
public final class NettyRuntime {
    ...
    static class AvailableProcessorsHolder {
         ...
         * This can be overridden by setting the system property "io.netty5.availableProcessors" or by invoking
     ...
     * can be overridden by setting the system property "io.netty5.availableProcessors" or by invoking
     * {@link #setAvailableProcessors(int)} before any calls to this method.
     *
     * @return the configured number of available processors
     */
