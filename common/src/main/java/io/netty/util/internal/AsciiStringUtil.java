...
public final class AsciiStringUtil {
     ...
     */
    public static AsciiString toLowerCase(final AsciiString string) {
     ...
     */
    public static AsciiString toUpperCase(final AsciiString string) {
        final byte[] byteArray = string.array();
        final int offset = string.arrayOffset();
        final int length = string.length();
     ...
     */
    public static byte toLowerCase(final byte value) {
     ...
     */
    public static byte toUpperCase(final byte value) {
