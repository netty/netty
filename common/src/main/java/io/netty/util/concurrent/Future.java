...
public interface Future<V> extends java.util.concurrent.Future<V> {
     ...
     * nested futures are "flattened" into a {@code Future<R>} by this method. Note that the future returned by this
     * method is not the same instance as the one the mapper function returns. The reason is that this method needs to
     * return immediately, but the mapper function cannot be applied before this future has completed.
     * <p>
     * If this future fails, then the returned future will fail as well, with the same exception. Cancellation of either
     * future will cancel the other. If the mapper function throws, the returned future will fail, but this future will
     * be unaffected.
