...
public class JZlibDecompressor extends ZlibDecompressor {
    ...
    ByteBuf processOutput(ByteBuf buf) throws DecompressionException {
        ByteBuf decompressed = allocator.heapBuffer(outputBufferSize(z.avail_in));
        ...
        try {
            ...
            int outputLength = z.next_out_index - decompressed.arrayOffset();
            decompressed.writerIndex(outputLength);
            ...
            switch (resultCode) {
                ...
                case JZlib.Z_BUF_ERROR:
                    if (outputLength == 0 && oldNextInIndex == z.next_in_index && z.avail_in > 0) {
