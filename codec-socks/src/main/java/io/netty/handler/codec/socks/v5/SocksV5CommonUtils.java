...
public final class SocksV5CommonUtils {
    public static final SocksV5Request UNKNOWN_SOCKS_REQUEST = new UnknownSocksV5Request();
    public static final SocksV5Response UNKNOWN_SOCKS_RESPONSE = new UnknownSocksV5Response();
