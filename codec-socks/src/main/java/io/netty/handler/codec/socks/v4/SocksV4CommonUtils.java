...
import io.netty.handler.codec.socks.v5.SocksV5Response;

import io.netty.util.internal.StringUtil;

public final class SocksV4CommonUtils {
    public static final SocksV4Request UNKNOWN_SOCKS_V4_REQUEST = new UnknownSocksV4Request();
    public static final SocksV4Response UNKNOWN_SOCKS_V4_RESPONSE = new UnknownSocksV4Response();
