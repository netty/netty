...
public class CipherSuiteUtilTest {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(CipherSuiteUtilTest.class);
    ...
    private static void testJ2OMapping(String javaCipherSuite, String openSslCipherSuite) {
        final String actual = CipherSuiteUtil.toOpenSslUncached(javaCipherSuite);
    ...
    private static void testO2JMapping(String javaCipherSuite, String openSslCipherSuite) {
        final String actual = CipherSuiteUtil.toJavaUncached(openSslCipherSuite);
    ...
    private static void testCachedJ2OMapping(String javaCipherSuite, String openSslCipherSuite) {
        CipherSuiteUtil.clearCache();

        final String actual1 = CipherSuiteUtil.toOpenSsl(javaCipherSuite);
        assertThat(actual1, is(openSslCipherSuite));

        // Ensure that the cache entries have been created.
        assertThat(CipherSuiteUtil.isJ2OCached(javaCipherSuite, actual1), is(true));
        assertThat(CipherSuiteUtil.isO2JCached(actual1, javaCipherSuite.substring(4)), is(true));

        final String actual2 = CipherSuiteUtil.toOpenSsl(javaCipherSuite);
    ...
    private static void testCachedO2JMapping(String javaCipherSuite, String openSslCipherSuite) {
        ...
        final String tlsActual1 = CipherSuiteUtil.toJava(openSslCipherSuite, "TLS");
        final String sslActual1 = CipherSuiteUtil.toJava(openSslCipherSuite, "SSL");
        assertThat(tlsActual1, is(tlsExpected));
        assertThat(sslActual1, is(sslExpected));

        // Ensure that the cache entries have been created.
        assertThat(CipherSuiteUtil.isO2JCached(openSslCipherSuite, javaCipherSuite), is(true));
        assertThat(CipherSuiteUtil.isJ2OCached(tlsExpected, openSslCipherSuite), is(true));
        assertThat(CipherSuiteUtil.isJ2OCached(sslExpected, openSslCipherSuite), is(true));

        final String tlsActual2 = CipherSuiteUtil.toJava(openSslCipherSuite, "TLS");
        final String sslActual2 = CipherSuiteUtil.toJava(openSslCipherSuite, "SSL");
