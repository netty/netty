            ...
            Object maybeMethods = AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                public Object run() {
                    try {
                        ...
                        methods.add(x509CertInfoClass.getDeclaredMethod("set", String.class, Object.class));
                        methods.add(x509CertImplClass.getDeclaredMethod("get", String.class));

                        methods.add(x509CertImplClass.getDeclaredMethod(
                                "sign", PrivateKey.class, String.class));
                        methods.add(algorithmIdClass.getDeclaredMethod("get", String.class));
                        return methods;
                    } catch (Throwable cause) {
                        return cause;
                    }
        ...
        try {
            ...
            CERT_INFO_SET_HANDLE.invoke(info, "algorithmID",
                    ...
                    CERTIFICATE_ALORITHM_ID_CONSTRUCTOR.newInstance(
                            ALGORITHM_ID_GET_HANDLE.invoke(null, "1.2.840.113549.1.1.11")));
