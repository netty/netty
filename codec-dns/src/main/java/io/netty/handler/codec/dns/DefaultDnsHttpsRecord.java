...
/**
 * The default {@link DnsHttpsRecord} implementation.
 */
public final class DefaultDnsHttpsRecord extends AbstractDnsRecord implements DnsHttpsRecord {
     ...
     */
    public DefaultDnsHttpsRecord(String name, int dnsClass, long timeToLive,
                                 int priority, String targetName, Map<Integer, byte[]> parameters) {
        super(name, DnsRecordType.HTTPS, dnsClass, timeToLive);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DnsHttpsRecord)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        DnsHttpsRecord that = (DnsHttpsRecord) obj;
