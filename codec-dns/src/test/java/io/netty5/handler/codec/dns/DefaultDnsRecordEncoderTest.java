...
public class DefaultDnsRecordEncoderTest {
    ...
    public void testEncodePtr() throws Exception {
        ...
        try (Buffer out = onHeapAllocator().allocate(512); Buffer expectedBuf = onHeapAllocator().allocate(512)) {
            ...
            expectedBuf.writeShort((short) DnsRecordType.PTR.intValue());
            expectedBuf.writeShort((short) DnsRecord.CLASS_IN);
            ...
            expectedBuf.writeShort((short) hostname.length);
