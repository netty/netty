 ...
 * <br>
 * Usage example (given that the {@code haystack} is a {@link io.netty5.buffer.ByteBuf} containing "ABCD" and the
...
public abstract class AbstractMultiSearchProcessorFactory implements MultiSearchProcessorFactory {
     ...
     * Every byte of {@link io.netty5.buffer.ByteBuf} is processed only once, sequentually, regardles of
