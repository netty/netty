...
public abstract class AbstractByteBuf extends ByteBuf {
    ...
    private static final String PROP_CHECK_ACCESSIBLE = "io.netty5.buffer.checkAccessible";
    static final boolean checkAccessible; // accessed from CompositeByteBuf
    private static final String PROP_CHECK_BOUNDS = "io.netty5.buffer.checkBounds";
