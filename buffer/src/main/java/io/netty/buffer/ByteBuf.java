 ...
 *
 * You can create a view of an existing buffer using the following methods:
 * <ul>
 ...
 * {@link #sliceRetained()}, {@link #sliceRetained(int, int)} and {@link #readSliceRetained(int)} which may yield
 * better memory footprint than its non-retaining counterpart.
 *
...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
     ...
     * @param length the size of the new slice
     *
     * @return the newly created retained slice
     *
     * @throws IndexOutOfBoundsException
     *         if {@code length} is greater than {@code this.readableBytes}
     */
     ...
     * of the returned buffer or this buffer affects each other's content
     * while they maintain separate indexes and marks.  This method is
     * identical to {@code buf.sliceRetained(buf.readerIndex(), buf.readableBytes())}.
     * This method does not modify {@code readerIndex} or {@code writerIndex} of
     * this buffer.
     */
     ...
     * Modifying the content of the returned buffer or this buffer affects
     * each other's content while they maintain separate indexes and marks.
     * This method is identical to {@code buf.sliceRetained(0, buf.capacity())}.
     * This method does not modify {@code readerIndex} or {@code writerIndex} of
     * this buffer.
     */
