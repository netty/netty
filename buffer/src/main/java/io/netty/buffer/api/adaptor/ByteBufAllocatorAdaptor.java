...
public class ByteBufAllocatorAdaptor implements ByteBufAllocator, AutoCloseable {
    ...
    public ByteBuf buffer(int initialCapacity, int maxCapacity) {
        return initialise(onheap.allocate(initialCapacity).order(BIG_ENDIAN), maxCapacity);
    }
    ...
    public ByteBuf directBuffer(int initialCapacity, int maxCapacity) {
        return initialise(offheap.allocate(initialCapacity).order(BIG_ENDIAN), maxCapacity);
    }
