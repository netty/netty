...
/** Utility to flush response and keep the connection alive. */
public final class KeepAlive {
    public static ChannelFuture flushResponse(ChannelHandlerContext ctx, HttpRequest req, HttpResponse res) {
    ...
    public static ChannelFuture flushResponse(Channel ch, HttpRequest req, HttpResponse res) {
        if (!HttpHeaders.isKeepAlive(req)) {
