...
public final class MsgEchoClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final NioEventLoopGroup connectGroup = new NioEventLoopGroupBuilder().setnThreads(1).setThreadFactory(connectFactory).setSelectorProvider(NioUdtProvider.MESSAGE_PROVIDER).createNioEventLoopGroup();
        try {
