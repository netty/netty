...
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.connectDataIdempotent;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.connectResumeOnReadWrite;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evAdd;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evClear;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evDelete;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evDisable;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evEOF;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evEnable;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evError;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evfiltRead;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evfiltSock;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evfiltUser;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.evfiltWrite;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.fastOpenClient;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.fastOpenServer;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.noteConnReset;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.noteDisconnected;
import static io.netty5.channel.kqueue.KQueueStaticallyReferencedJniMethods.noteReadClosed;
