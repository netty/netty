 ...
 * under the License.
 */
package io.netty.microbench.handler.codec.http;
...
public class HttpRequestEncoderInsertBenchmark extends AbstractMicrobenchmark {
    ...
    private final OpenHttpRequestEncoder encoderNew = new OpenHttpRequestEncoder();

    private static final class OpenHttpRequestEncoder extends HttpRequestEncoder {
        @Override
