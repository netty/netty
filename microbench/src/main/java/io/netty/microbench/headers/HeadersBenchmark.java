...
public class HeadersBenchmark extends AbstractMicrobenchmark {
    ...
    public void setup() {
        ...
        slowHttpHeaders = new SlowHeaders(httpHeaders);
    ...
    @Benchmark
    @BenchmarkMode(Mode.AverageTime)
    public void httpAddAllSlow(Blackhole bh) {
        bh.consume(emptyHttpHeaders.add(slowHttp2Headers));
    }
