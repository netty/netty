...
public class HeapByteBufBenchmark extends AbstractMicrobenchmark {
    ...
    public void setup() throws Exception {
        System.setProperty("io.netty5.buffer.bytebuf.checkBounds", checkBounds);
        unsafeBuffer = newBuffer("io.netty5.buffer.UnpooledUnsafeHeapByteBuf");
        buffer = newBuffer("io.netty5.buffer.UnpooledHeapByteBuf");
