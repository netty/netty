        ...
        for (;;) {
            switch (currentState) {
                ...
                case DECODE_HUFFMAN_DATA:
                    ...
                    // exception. Because previous operation may read only a few bits from Bzip2BitReader.bitBuffer
                    // and don't read incoming ByteBuf.
                    ...
                    try {
                        ...
                        // Return here so the ByteBuf that was put in the List will be forwarded to the user and so
