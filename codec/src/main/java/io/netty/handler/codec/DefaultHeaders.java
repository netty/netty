...
public class DefaultHeaders<T> implements Headers<T> {
    ...
    /**
     * This method is purposfully kept simple and returns {@link #size()} as the hash code.
     ...
     *      example {@link TreeMap#hashCode()} does not fullfill the contract between {@link Object#hashCode()} and
     ...
     *      soley there because we override {@link Object#equals(Object)}, which makes it easier to use {@link Headers}
