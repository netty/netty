...
public class IpSubnetFilterRule extends IpSubnet implements IpFilterRule {
    /**
     * Is this IpSubnet an ALLOW or DENY rule
     */
     ...
     * @param cidrNetMask
     */
    public IpSubnetFilterRule(boolean allow, InetAddress inetAddress, int cidrNetMask) {
     ...
     * @param netMask
     */
    public IpSubnetFilterRule(boolean allow, InetAddress inetAddress, String netMask) {
