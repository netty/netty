...
public class DynamicPartialByteArray extends AbstractByteArray {
    ...
    public DynamicPartialByteArray(ByteArray array) {
        ...
        ByteArray originalArray = array;
        // Unwrap if possible.
        if (originalArray instanceof PartialByteArray) {
            originalArray = ((PartialByteArray) array).unwrap();
        }
        if (originalArray instanceof DynamicPartialByteArray) {
            originalArray = ((DynamicPartialByteArray) array).unwrap();
        }
    ...
    public void firstIndex(int firstIndex) {
        ...
        if (firstIndex > array.endIndex()) {
            throw new IllegalArgumentException(
                    "firstIndex must be less than " + array.endIndex() + ".");
        }

        length -= firstIndex - this.firstIndex;
