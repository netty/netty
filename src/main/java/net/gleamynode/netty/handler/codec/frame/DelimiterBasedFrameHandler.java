 ...
 *
 */
public class DelimiterBasedFrameHandler extends FrameHandler {

    private final ByteArray[] delimiters;
    private final int maxFrameLength;

    public DelimiterBasedFrameHandler(int maxFrameLength, ByteArray delimiter) {
    ...
    public DelimiterBasedFrameHandler(int maxFrameLength, ByteArray... delimiters) {
        validateMaxFrameLength(maxFrameLength);
        if (delimiters == null) {
    ...
    @Override
    protected ByteArray readFrame(ByteArrayBuffer buffer) throws Exception {
        // Try all delimiters.
