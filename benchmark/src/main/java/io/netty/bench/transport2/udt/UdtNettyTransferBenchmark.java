...
package io.netty.bench.transport2.udt;

import io.netty.bench.util.CustomReporter;
 ...
 */
public final class UdtNettyTransferBenchmark {

    private UdtNettyTransferBenchmark() {
    }

    static final Logger log = LoggerFactory
            .getLogger(UdtNettyTransferBenchmark.class);
    ...
    static final Counter benchTime = Metrics.newCounter(
            UdtNettyTransferBenchmark.class, "bench time");

    static final Counter benchSize = Metrics.newCounter(
            UdtNettyTransferBenchmark.class, "bench size");
    ...
    static final Meter rate = Metrics.newMeter(UdtNettyTransferBenchmark.class,
            "rate", "bytes", TimeUnit.SECONDS);
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Bootstrap peerBoot1 = BootUtil.messagePeerBoot(addr1, addr2,
                handler1);
        final Bootstrap peerBoot2 = BootUtil.messagePeerBoot(addr2, addr1,
                handler2);
