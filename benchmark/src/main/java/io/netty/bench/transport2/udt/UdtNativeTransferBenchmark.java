...
import io.netty.bench.transport2.TransferBenchmark;
...
public class UdtNativeTransferBenchmark extends TransferBenchmark {
    ...
    protected static List<String> latencyValues() {
        return TransferBenchmark.latencyList();
    }
    ...
    protected static List<String> messageValues() {
        return TransferBenchmark.messageList();
    }
    ...
    protected static List<String> durationValues() {
        return TransferBenchmark.durationList();
    }
    ...
    protected void tearDown() throws Exception {
        ...
        NetworkUtil.socketAwait(peer1, StatusUDT.CLOSED, StatusUDT.BROKEN);
        NetworkUtil.socketAwait(peer2, StatusUDT.CLOSED, StatusUDT.BROKEN);
    ...
    public static void main(final String[] args) throws Exception {
        MetricsRunner.execute(UdtNativeTransferBenchmark.class);
    }
}
