...
import static io.netty.codec.http3.Http3CodecUtils.closeOnFailure;
import static io.netty.codec.http3.Http3CodecUtils.connectionError;
import static io.netty.codec.http3.Http3CodecUtils.criticalStreamClosed;
import static io.netty.codec.http3.Http3ErrorCode.H3_FRAME_UNEXPECTED;
import static io.netty.codec.http3.Http3ErrorCode.H3_ID_ERROR;
import static io.netty.codec.http3.Http3ErrorCode.H3_MISSING_SETTINGS;
import static io.netty.codec.http3.Http3ErrorCode.QPACK_ENCODER_STREAM_ERROR;
import static io.netty.codec.http3.Http3SettingsFrame.HTTP3_SETTINGS_QPACK_BLOCKED_STREAMS;
import static io.netty.codec.http3.Http3SettingsFrame.HTTP3_SETTINGS_QPACK_MAX_TABLE_CAPACITY;
import static io.netty.codec.http3.QpackUtil.toIntOrThrow;
