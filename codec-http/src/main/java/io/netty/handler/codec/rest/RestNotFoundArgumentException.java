...
/**
 * Raised when a mandatory argument is not found
 */
public class RestNotFoundArgumentException extends Exception {

    private static final long serialVersionUID = -3927616369193019531L;
