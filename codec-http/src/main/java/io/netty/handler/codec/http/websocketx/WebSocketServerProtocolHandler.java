...
public class WebSocketServerProtocolHandler extends ChannelInboundMessageHandlerAdapter<WebSocketFrame> {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        if (cause instanceof WebSocketHandshakeException) {
            HttpResponseWithEntityWithEntity response = new DefaultHttpResponseWithEntityWithEntity(HTTP_1_1, HttpResponseStatus.BAD_REQUEST);
        ...
        return new ChannelInboundMessageHandlerAdapter<Object>() {
            ...
            public void messageReceived(ChannelHandlerContext ctx, Object msg) throws Exception {
                if (!(msg instanceof WebSocketFrame)) {
                    HttpResponseWithEntityWithEntity response = new DefaultHttpResponseWithEntityWithEntity(HTTP_1_1, HttpResponseStatus.FORBIDDEN);
