...
/**
 * Rest exception for an invalid authentication
 */
public class RestInvalidAuthenticationException extends Exception {
    private static final long serialVersionUID = 8186094988169810353L;
