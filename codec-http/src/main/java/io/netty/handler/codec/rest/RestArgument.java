...
public class RestArgument {
    public static enum REST_ROOT_FIELD {
        ...
        public final AsciiString field;
        public final String fieldNormalCase;
        public final String fieldLowerCase;
        REST_ROOT_FIELD(String field) {
            this.field = new AsciiString(field);
            this.fieldNormalCase = field;
            this.fieldLowerCase = field.toLowerCase();
        }
    }
    ...
    public void setRequest(HttpRequest request) {
        ...
        for (Entry<String, String> entry : request.headers().entriesConverted()) {
            String key = entry.getKey();
            if (! HttpHeaderNames.COOKIE.contentEquals(key)) {
                if (REST_ROOT_FIELD.ARG_X_AUTH_KEY.field.equalsIgnoreCase(key)) {
                    addArg(REST_ROOT_FIELD.ARG_X_AUTH_KEY.fieldNormalCase, entry.getValue());
                    continue;
                }
                if (REST_ROOT_FIELD.ARG_X_AUTH_USER.field.equalsIgnoreCase(key)) {
                    addArg(REST_ROOT_FIELD.ARG_X_AUTH_USER.fieldNormalCase, entry.getValue());
                    continue;
                }
                if (REST_ROOT_FIELD.ARG_X_AUTH_TIMESTAMP.field.equalsIgnoreCase(key)) {
                    addArg(REST_ROOT_FIELD.ARG_X_AUTH_TIMESTAMP.fieldNormalCase, entry.getValue());
                    continue;
                }
                if (REST_ROOT_FIELD.ARG_METHOD.field.equalsIgnoreCase(key)) {
    ...
    public static String[] getBaseAuthent(Key hmac, String algo, QueryStringEncoder encoder,
        ...
        treeMap.put(REST_ROOT_FIELD.ARG_X_AUTH_TIMESTAMP.fieldLowerCase, isodate);
        if (user != null) {
            treeMap.put(REST_ROOT_FIELD.ARG_X_AUTH_USER.fieldLowerCase, user);
        }
        try {
    ...
    public void checkTime(long maxtime) throws RestInvalidAuthenticationException {
        ...
        String sdate = arg(REST_ROOT_FIELD.ARG_X_AUTH_TIMESTAMP.fieldNormalCase);
        if (sdate == null) {
    ...
    public void checkBaseAuthent(Key hmac, String algo, String extraKey, long maxInterval)
        ...
        String user = arg(REST_ROOT_FIELD.ARG_X_AUTH_USER.fieldNormalCase);
        ...
        if (!key.equalsIgnoreCase(arg(REST_ROOT_FIELD.ARG_X_AUTH_KEY.fieldNormalCase))) {
    ...
    protected static String computeKey(Key hmac, String algo, String extraKey,
        ...
        if (extraKey != null) {
            ...
            builder.append(REST_ROOT_FIELD.ARG_X_AUTH_INTERNALKEY.fieldNormalCase);
            builder.append("=");
