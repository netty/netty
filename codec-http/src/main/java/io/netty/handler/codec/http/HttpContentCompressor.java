...
/**
 * Compresses an {@link HttpHeaders} and an {@link HttpContent} in {@code gzip} or
...
public class HttpContentCompressor extends HttpContentEncoder {
    ...
    @Override
    protected Result beginEncode(HttpHeaders headers, HttpContent msg, String acceptEncoding) throws Exception {
