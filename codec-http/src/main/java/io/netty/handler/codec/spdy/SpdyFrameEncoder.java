...
public class SpdyFrameEncoder extends MessageToByteEncoder<SpdyFrame> {
    ...
    protected void encode(ChannelHandlerContext ctx, SpdyFrame msg, ByteBuf out) throws Exception {
        if (msg instanceof SpdyDataFrame) {
            ...
            ByteBuf data = headerBlockEncoder.encode(spdySynStreamFrame, ctx.alloc());
            try {
            ...
            ByteBuf data = headerBlockEncoder.encode(spdySynReplyFrame, ctx.alloc());
            try {
            ...
            ByteBuf data = headerBlockEncoder.encode(spdyHeadersFrame, ctx.alloc());
            try {
