...
public class QueryStringDecoder {
    ...
    private boolean addParam(Map<String, List<String>> params, String name,
            String value) {
     ...
     * Actually this function doesn't allocate any memory if there's nothing to
     * decode, the argument itself is returned.
     * 
     * @param s
     *            The string to decode (can be empty).
     * @param charset
    ...
    public static String decodeComponent(final String s, final Charset charset) {
        ...
        String str = null;
        try {
            str = new String(buf, 0, pos, charset.name());
