...
public abstract class HttpObjectDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
        ...
        case READ_HEADER: try {
            ...
            case SKIP_CONTROL_CHARS:
                ...
                out.add(message);
                out.add(createEmptyLastHttpContent());
                resetNow();
                return;
        ...
        case READ_VARIABLE_LENGTH_CONTENT: {
            ...
            if (toRead > 0) {
                ...
                out.add(createHttpContent(content));
            }
            return;
        }
        ...
        case READ_CHUNKED_CONTENT: {
            ...
            HttpContent chunk = createHttpContent(buffer.readSlice(toRead).retain());
            chunkSize -= toRead;
    ...
    private HttpContent invalidChunk(ByteBuf in, Exception cause) {
        ...
        HttpContent chunk = createLastHttpContent(Unpooled.EMPTY_BUFFER);
    ...
    private LastHttpContent readTrailingHeaders(ByteBuf buffer) {
        ...
        if (line.length() > 0) {
            ...
            if (trailer == null) {
                trailer = this.trailer = createLastHttpContent(Unpooled.EMPTY_BUFFER);
            }
            do {
                char firstChar = line.charAt(0);
        ...
        return createEmptyLastHttpContent();
    }
    ...
    protected HttpContent createHttpContent(ByteBuf content) {
        return new DefaultHttpContent(content);
    }

    protected LastHttpContent createLastHttpContent(ByteBuf content) {
        return new DefaultLastHttpContent(content, validateHeaders);
    }

    protected LastHttpContent createEmptyLastHttpContent() {
