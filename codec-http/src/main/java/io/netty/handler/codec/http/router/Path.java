 ...
 *
 * The path is broken to tokens, example:
...
class Path {
    ...
    /** The path will be stored with slashes at both ends removed. */
    ...
    //--------------------------------------------------------------------------
    // Need these so that Paths can be used as Map keys without pain.
