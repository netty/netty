...
public abstract class WebSocketServerHandshaker {
     ...
     *            HTTP Request
     */
    public ChannelFuture handshake(Channel channel, HttpRequestWithContent req) {
        if (channel == null) {
     ...
     */
    public abstract ChannelFuture handshake(Channel channel, HttpRequestWithContent req, ChannelPromise promise);
