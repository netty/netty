...
import static io.netty5.util.internal.StringUtil.decodeHexByte;
...
public class QueryStringDecoder {
    ...
    private QueryStringDecoder(Builder builder, String uri) {
        ...
        this.charset = requireNonNull(builder.charset, "charset");
     ...
     * be {@link java.nio.charset.StandardCharsets#UTF_8}.
     * @return The decoded string, or {@code s} if there's nothing to decode.
     * If the string to decode is {@code null}, returns an empty string.
     * @throws IllegalArgumentException if the string contains a malformed
     * escape sequence.
