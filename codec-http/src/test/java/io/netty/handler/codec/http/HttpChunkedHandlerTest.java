...
public class HttpChunkedHandlerTest {
    ...
    public void testChunkedStream() {
        check(new HttpChunkedStream(new ByteArrayInputStream(BYTES)));
    }

    @Test
    public void testChunkedNioStream() {
        check(new HttpChunkedNioStream(Channels.newChannel(new ByteArrayInputStream(BYTES))));
    }

    @Test
    public void testChunkedFile() throws IOException {
        check(new HttpChunkedFile(TMP));
    }

    @Test
    public void testChunkedNioFile() throws IOException {
        check(new HttpChunkedNioFile(TMP));
    }
