...
import static io.netty.handler.codec.http.websocketx.extensions.compression.WebSocketServerCompressionHandlerTest.*;
...
public class WebSocketClientCompressionHandlerTest {
    ...
    public void testServerWindowSizeSuccess() {
        EmbeddedChannel ch = new EmbeddedChannel(new WebSocketClientExtensionHandler(
                        new PerMessageDeflateClientExtensionHandshaker(6, false, 10, false, false)));
