...
import static io.netty.handler.codec.http.cookie.ServerCookieDecoder.ServerCookieDecoderBuilder;
...
public class ServerCookieDecoderTest {
    ...
    public void testRejectCookieNameWithCommaWithException() {
        new ServerCookieDecoderBuilder()
                .strict(true)
                .cookieErrorHandler(new CookieDecoder.CookieErrorHandler() {
                    @Override
