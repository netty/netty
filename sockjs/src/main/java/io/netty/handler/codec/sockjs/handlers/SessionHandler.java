...
public class SessionHandler extends ChannelInboundHandlerAdapter implements SessionContext {
    ...
    private void handleSession(final ChannelHandlerContext ctx) throws Exception {
        ...
        case CONNECTING:
            ...
            ctx.channel().write(new OpenFrame());
        ...
        case OPEN:
            ...
            break;
        case INTERRUPTED:
            ctx.write(new CloseFrame(1002, "Connection interrupted"));
            break;
        case CLOSED:
            ctx.write(new CloseFrame(3000, "Go away!"));
    ...
    public void send(String message) {
        ...
        if (isWritable(channel)) {
            channel.write(new MessageFrame(message));
        } else {
    ...
    public void close() {
        ...
        if (isWritable(channel)) {
            ...
            channel.write(closeFrame).addListener(ChannelFutureListener.CLOSE);
        }
    }
