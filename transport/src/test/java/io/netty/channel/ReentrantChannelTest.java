...
public class ReentrantChannelTest extends BaseChannelTest {
    ...
    public void testWritabilityChanged() throws Exception {
        ...
        cb.option(ChannelOption.WRITE_BUFFER_LOW_WATER_MARK, 512);
        cb.option(ChannelOption.WRITE_BUFFER_HIGH_WATER_MARK, 1024);
        ...
        // writeAndFlush behaves differently:  the write + flush cancel out and do not affect writability
