...
public interface ChannelInboundHandler extends ChannelHandler {
    ...
    @ChannelHandlerMask.Skip
    default void channelShutdown(ChannelHandlerContext ctx, ChannelShutdownType type) throws Exception {
        ctx.fireChannelShutdown(type);
    }

    /**
     * Gets called if a {@link Throwable} was thrown from an {@link ChannelInboundHandler}.
     */
    @ChannelHandlerMask.Skip
