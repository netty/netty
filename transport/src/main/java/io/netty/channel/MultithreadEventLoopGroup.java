...
public abstract class MultithreadEventLoopGroup
     ...
     */
    protected MultithreadEventLoopGroup(int nThreads, Executor executor, EventLoopChooser chooser, Object... args) {
        super(nThreads == 0 ? DEFAULT_EVENT_LOOP_THREADS : nThreads, executor, chooser, args);
    }
    ...
    protected MultithreadEventLoopGroup(
            int nThreads, ThreadFactory threadFactory, EventLoopChooser chooser, Object... args) {
        super(nThreads == 0 ? DEFAULT_EVENT_LOOP_THREADS : nThreads, threadFactory, chooser, args);
    }
    ...
    public ChannelFuture register(Channel channel) {
        return next(channel.remoteAddress()).register(channel);
    }

    @Override
    public ChannelFuture register(Channel channel, ChannelPromise promise) {
        return next(channel.remoteAddress()).register(channel, promise);
    }
}
