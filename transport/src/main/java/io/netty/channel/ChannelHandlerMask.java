        ...
        try {
            ...
            if (ChannelOutboundHandler.class.isAssignableFrom(handlerType)) {
                ...
                if (isSkippable(handlerType, "bind", ChannelHandlerContext.class,
                        SocketAddress.class, CompletionHandler.class)) {
                    mask &= ~MASK_BIND;
                }
                ...
                if (isSkippable(handlerType, "disconnect", ChannelHandlerContext.class, CompletionHandler.class)) {
                    mask &= ~MASK_DISCONNECT;
                }
                if (isSkippable(handlerType, "close", ChannelHandlerContext.class, CompletionHandler.class)) {
                    mask &= ~MASK_CLOSE;
                }
                if (isSkippable(handlerType, "deregister", ChannelHandlerContext.class, CompletionHandler.class)) {
                ...
                if (isSkippable(handlerType, "register", ChannelHandlerContext.class, CompletionHandler.class)) {
                    mask &= ~MASK_REGISTER;
                }
                if (isSkippable(handlerType, "shutdown", ChannelHandlerContext.class,
                        ChannelShutdownType.class, CompletionHandler.class)) {
                    mask &= ~MASK_SHUTDOWN;
                }
