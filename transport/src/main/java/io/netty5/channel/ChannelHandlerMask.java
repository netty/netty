...
final class ChannelHandlerMask {
    ...
    static final int MASK_CHANNEL_PROTOCOL_CHANGED = 1 << 9;

    static final int MASK_CHANNEL_WRITABILITY_CHANGED = 1 << 10;
    static final int MASK_BIND = 1 << 11;
    static final int MASK_CONNECT = 1 << 12;
    static final int MASK_DISCONNECT = 1 << 13;
    static final int MASK_CLOSE = 1 << 14;
    static final int MASK_SHUTDOWN = 1 << 15;
    static final int MASK_REGISTER = 1 << 16;
    static final int MASK_DEREGISTER = 1 << 17;
    static final int MASK_READ = 1 << 18;
    static final int MASK_WRITE = 1 << 19;
    static final int MASK_FLUSH = 1 << 20;
    static final int MASK_SEND_OUTBOUND_EVENT = 1 << 21;
    ...
    private static final int MASK_ALL_INBOUND = MASK_CHANNEL_EXCEPTION_CAUGHT | MASK_CHANNEL_REGISTERED |
            ...
            MASK_CHANNEL_INBOUND_EVENT | MASK_CHANNEL_PROTOCOL_CHANGED;
    ...
    private static int mask0(Class<? extends ChannelHandler> handlerType) {
        ...
        try {
            ...
            if (isSkippable(handlerType, "channelProtocolChanged",
                    ChannelHandlerContext.class, ChannelProtocolChangeEvent.class)) {
                mask &= ~MASK_CHANNEL_PROTOCOL_CHANGED;
            }
